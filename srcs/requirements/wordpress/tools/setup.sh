...
while ! mysql -h${MYSQL_HOSTNAME} -u${MYSQL_USERNAME} -p${MYSQL_WORDPRESS_DATABASE} -e ";" &> /dev/null; do
...
if [! -f "/var/www/html/index.html"] then
	...
	wp core install \
		...
		--admin_user=${WORD_PRESS_ADMIN_NAME} \
...
echo "[WP Container] starting php-fpm"
